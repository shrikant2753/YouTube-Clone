...
function addDeatailsOntoDOM(videoInfo, channelDetails) {
    ...
    const subscribersCount = abbreviateNumber(channelDetails.items[0].statistics.subscriberCount)
    ...
    commentsDetails.forEach((comment) => {
        ...
        commentElement.innerHTML =
            ...
            replayButton.addEventListener("click", () => {
                ...
                const repliesSection = commentElement.querySelector(".c-replies");
...
// function addCommentsRepliesOntoDOM(replies) {
//     // Create a wrapper element for the replies
//     const repliesWrapper = document.createElement("div");
//     repliesWrapper.className = "replies-wrapper";
...
//     // Return the replies wrapper
//     c_replies.appendChild(repliesWrapper);
// }

// function addCommentsRepliesOntoDOM(commentReplies){
//     let wrapper = document.createElement("div");
//     wrapper.className = "wrapper";
...
//                     <span>${snippet.totalReplyCount} replies</span>
//                 </div>
//                 <div class="c-replies"> <!-- This is the replies section -->
//                     <!-- Add the replies here, you can use a similar loop as above -->
//                 </div>
//             </div>`;
...
//                 // Toggle the visibility of the replies section
//                 repliesSection.style.display = repliesSection.style.display === "none" ? "block" : "none";
//                 addCommentsRepliesOntoDOM(comment.replies)
//         });

//         wrapper.appendChild(commentElement);
//     });

//     comments.appendChild(c-replies);
// }
